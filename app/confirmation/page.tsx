        ...
        <div className="bg-white rounded-lg shadow-lg p-8">
          ...
          {appointment.transaction_hash && (
            <div className="mt-6 bg-gray-50 p-4 rounded-lg">
              ...
              <p className="text-xs text-gray-600 break-all">{appointment.transaction_hash}</p>
            </div>
          )}

          <div className="mt-8 flex gap-4">
            <Link href="/appointments" className="flex-1 px-6 py-3 bg-blue-600 text-white text-center rounded-lg hover:bg-blue-700 transition-colors">
              View My Appointments
            </Link>
            <Link href="/" className="flex-1 px-6 py-3 border border-gray-300 text-gray-700 text-center rounded-lg hover:bg-gray-50 transition-colors">
              Book Another
            </Link>
          </div>
        </div>
